...
player1 = Player(name, Hand(half2))

total_rounds = 0
war_count = 0

while player1.still_has_cards() and comp.still_has_cards():
  total_rounds += 1
...
print("gameover, number of round: "+ str(total_rounds))
print('a war happened ' + str(war_count)+ " times")
print("Does the computer still have cards?")
print(str(comp.still_has_cards()))
print("Does the playerOne still have cards?")
